            ...
            >
              ...
              <div className="flex flex-row gap-1 flex-wrap">
                <a
                  ...
                  className="font-heading text-sm sm:text-[15px] text-[#0E0E0E] break-all sm:break-normal hover:underline"
                >
                  +91 96007 78983
                </a>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6'>
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className='font-heading text-sm sm:text-[15px] text-[#0E0E0E] hover:underline'
                >
                  +91 96007 78983
                </a>
              </motion.div>
